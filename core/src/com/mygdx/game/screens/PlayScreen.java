...
public class PlayScreen implements Screen {
    ...
    public PlayScreen(JavaSimpleGame game) {
        ...
        for (MapObject object : map.getLayers().get(TILED_GROUND_LAYER_INDEX).getObjects().getByType(RectangleMapObject.class)) {
        ...
        for (MapObject object : map.getLayers().get(TILED_PLATFORM_LAYER_INDEX).getObjects().getByType(RectangleMapObject.class)) {
            Rectangle rect = ((RectangleMapObject) object).getRectangle();
        ...
        for (MapObject object : map.getLayers().get(TILED_LADDER_LAYER_INDEX).getObjects().getByType(RectangleMapObject.class)) {
            Rectangle rect = ((RectangleMapObject) object).getRectangle();
        ...
        for (MapObject object : map.getLayers().get(TILED_UPPER_MARGIN_LAYER_INDEX).getObjects().getByType(RectangleMapObject.class)) {
            Rectangle rect = ((RectangleMapObject) object).getRectangle();
